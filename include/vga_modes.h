//VGA modes reference: https://files.osdev.org/mirrors/geezer/osd/graphics/modes.c
#define VGA_80X25_TEXT_MODE { \
    /* MISC */ \
    0x67, \
    /* SEQ */ \
...
#define VGA_8X16_FONT_SIZE 4096
#define VGA_8X16_FONT { \
